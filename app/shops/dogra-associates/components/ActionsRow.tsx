...
import { Phone, Download, MapPin, X, CalendarCheck, DraftingCompass, Star, Share2, FolderKanban, Globe2 } from 'lucide-react'
    ...
    <>
      <div className="space-y-3 w-full max-w-full min-w-0">
        ...
        <div className="grid grid-cols-2 gap-2 w-full min-w-0">
          ...
          >
            <DraftingCompass className="w-5 h-5 shrink-0" style={{ color: '#5E351F' }} />
          ...
          >
            <FolderKanban className="w-5 h-5 shrink-0" style={{ color: '#5E351F' }} />
